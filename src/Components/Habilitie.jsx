...
export default function Habilitie({ icon, title, url, className }) {
  return (
    <button
      className="z-50 flex h-14 items-center border-transparent border-2 hover:border-[#13cd518a] transition-colors gap-2 px-5 text-[16px] text-white rounded-full bg-habilitieBg font-maven-pro"
